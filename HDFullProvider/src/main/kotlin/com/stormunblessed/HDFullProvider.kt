...
class HDFullProvider : MainAPI() {
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse? {
        ...
        val urls = listOf(
            ...
            Pair("Anime", "$mainUrl/tags-tv/anime"),
        )
        urls.amap { (name, url) ->
            ...
            val home =
                doc.select("div.center div.view").amap {
                    ...
                    val type = if (link!!.contains("/pelicula")) TvType.Movie else if (link.contains("/episodios#anime")) TvType.Anime else TvType.TvSeries
                    val img =
